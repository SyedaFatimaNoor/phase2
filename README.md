# Noor# NoorTodo - Full-Stack Web Application (Phase II)

Welcome to **NoorTodo**, a premium full-stack to-do application built with Next.js, FastAPI, and SQLModel. This project is authored by **Syeda Noor Ul Ain Fatima** as part of the Evolution of Todo Hackathon.
and Neon PostgreSQL as part of the Noor Evolution series.
